# Generated by Powerlevel10k configuration wizard on 2025-07-23 at 14:01 SAST.
...
# 24h time, angled separators, slanted heads, sharp tails, 1 line, compact, many icons,
...
() {
  ...
  # Load color when load is under 51%.
